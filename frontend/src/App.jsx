function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="mx-auto grid w-full max-w-7xl gap-12 px-6 pb-16 pt-8 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:pt-16">
        <section className="space-y-8">
          ...
          <p className="max-w-xl text-base leading-7 text-slate-600 md:text-lg">
            HealthMate connects patients, doctors, and administrators on one secure platform for appointments, video consultations, digital prescriptions, and report management.
          </p>
        ...
        <section id="services" className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
      ...
      <footer id="contact" className="border-t border-slate-200 bg-white py-6">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-2 px-6 text-sm text-slate-500 md:flex-row lg:px-8">
          <p>© 2026 HealthMate. All rights reserved.</p>
          <p>support@healthmate.lk | +94 11 234 5678</p>
        </div>
      </footer>
    </div>
  );
